                                                        ...
                                                        <div class="form-group mb-3 row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <textarea name="address" class="form-control"
                                                                          placeholder="Add your Address">{{ $profileData->address }}</textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card-body mb-0">
                                                    <form action="{{ route('admin.password.update') }}" method="post">
                                                        ...
                                                        <div class="form-group mb-3 row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <input class="form-control @error('old_password') is-invalid @enderror" name="old_password" id="old_password" type="password"
