                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="code" class=" form-control"
                                                       placeholder="Enter Code" value="{{ $editData->code }}">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="price" class="form-control"
                                                       placeholder="Enter product price" value="{{ $editData->price }}">
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="note" rows="3"
                                                          placeholder="Enter Notes">{{ $editData->notes }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div class="card">
                                        ...
                                        <div class="row" id="preview_img">
                                            @php
                                                $productImages = $editData->images()->get();
                                            @endphp
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group w-100">
                                                ...
                                                <select name="status" id="status" class="form-control form-select">
                                                    ...
                                                    <option value="Received" {{ (isset($editData->status) && $editData->status == 'Received') ? 'selected' : ''}}>
                                                        Received
                                                    </option>
                                                    <option value="Pending" {{ (isset($editData->status) && $editData->status == 'Pending') ? 'selected' : ''}}>
                                                        Pending
                                                    </option>
                                                </select>
                                            </div>
